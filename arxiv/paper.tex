...
\title{The HP Protein-Folding Problem: Comparing Constraint Programming and Reinforcement Learning}
...
\keywords{HP model \and protein folding \and constraint programming \and CP-SAT \and reinforcement learning \and deep Q-learning \and lattice models}
...
This study presents a rigorous comparison of constraint programming and reinforcement learning for the 3D HP protein folding problem. We implement CP-SAT using Google OR-Tools with Large Neighbourhood Search and compare its performance against the Deep Q-Learning approach from Espitia et al.~(2024)~\cite{Espitia2024}, which we adapt and evaluate on our benchmark sequences.

\textbf{Paper structure as follows:}
\begin{itemize}[nosep]
    \item Section 2 describes the implementation and training procedures for each method.
    \item Section 3 presents comparative results and scaling behaviour.
    \item Section 4 discusses algorithmic trade-offs, failure modes, and future research directions.
\end{itemize}
